...
public class OpenEActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_eactivity);
    ...
    private void handleRadioButton(int index, float pitchInHz) {
        int[] lowerBounds = {81, 122, 164, 206, 245, 329};
        int[] upperBounds = {83, 124, 166, 208, 247, 331};
    ...
    private void handleSelectedTuningOption(int checkedId) {
        String[] soundNames = {"E6", "B5", "E4", "Ab", "B2", "E1"};
        float[] frequencies = {82, 123, 165, 207, 246, 330};

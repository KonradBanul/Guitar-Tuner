...
public class BassTuningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bass_tuning);
    ...
    private void handleRadioButton(int index, float pitchInHz) {
        int[] lowerBounds = {40, 54, 72, 97};
        int[] upperBounds = {42, 56, 74, 99};
    ...
    private void handleSelectedTuningOption(int checkedId) {
        String[] soundNames = {"E", "A", "D", "G"};
        float[] frequencies = {41, 55, 73, 98};
